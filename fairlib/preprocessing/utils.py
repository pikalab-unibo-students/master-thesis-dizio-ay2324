...
def get_privileged_unprivileged_masks(df, sensitive_columns: Optional[List[str]] = None) -> Tuple[pd.Series, pd.Series]:
    """
...
def get_favorable_unfavorable_masks(df, target_column: str, favorable_label: int = 1) -> Tuple[pd.Series, pd.Series]:
    """
